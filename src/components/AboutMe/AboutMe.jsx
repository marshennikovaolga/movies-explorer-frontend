            ...
            <Container>
                ...
                <div className="aboutme__container">
                    <div className="aboutme__description">
                        ...
                        <p className="aboutme__text">Привет, я фронтенд-разработчик на реакте. В данный момент расширяю свой стек изучая GraphQl и React Native, верстать предпочитаю на tailwind, в этом учебном проекте задействованы другие технологии. Сейчас нахожусь в Санкт-Петербурге, но готова рассмотреть вакансии с возможностью релокации. В дальнейшем заинтересована создавать маркетплейсы, мобильные приложения и мессенджеры 🌸</p>
